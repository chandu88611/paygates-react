  ...
  const checkout = async () => {
    ...
    try {
      const res = await axios.post(
        "https://parent.globalcrmsoftware.com/api/phonepe-api",
        {
          returnUrl:
          "https://checkout.globalcrmsoftware.com/payment-status/ph/",
          data:data,
          type:"child"
        }
      );    

...
import WL_paymentSuccess from './PH_paymentSuccess'
import WL_paymentFailure from './PH_paymentFailure'



function PH_paymentStatus() {
...
export default PH_paymentStatus
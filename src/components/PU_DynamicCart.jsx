...
formData1.append('type', "child");
    try {
      const res = await axios.post(
        "https://parent.globalcrmsoftware.com/api/payu-api",
        {
          returnUrl: "https://checkout.globalcrmsoftware.com/payment-status/pu/",
          data:data,
          type:"child"
        }
      );
     if(res.data.status){
      setFormData(res.data.payuFormData)
     }
    setLoading(false);
    } catch (error) {
      console.log(error);
  ...
  const submit_payu = async (key_,hash_,txn) => {
    setLoading(true);
    try {
      const res = await axios.post(
        "https://secure.payu.in/_payment",
        {
          ...
          surl: "https://checkout.globalpbxsoftware.com/payment-status/",
          furl: "https://checkout.globalpbxsoftware.com/payment-status/",
          ...
          headers:{
          // "Access-Control-Allow-Origin:":"https://api.payu.in"

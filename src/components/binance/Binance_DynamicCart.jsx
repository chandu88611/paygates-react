...
// function Airwallex_DynamicCart() {
//   const [manual,setManual]=useState(false)
//   const url = JSON.parse(localStorage.getItem("child_url"));
//   useEffect(() => {
//     const fetchData = async () => {
//       setLoading(true)
//       let domain=url?.data=="https://buyer.ftxtradingsoftware.com"?"https://finance.ftxtradingsoftware.com/api/pixel-fire":"https://finance.autotradesoftware.ae/api/pixel-fire"
//       try {
...
//                   <p>
//                  {url?.data==="https://buyer.ftxtradingsoftware.com"?"No-26-27,Mahatma Gandhi Road, Level-9, Raheja Towers, Bengaluru, Karnataka - 560001": "Standard Chartered Tower - Level 5 Emaar Square - Downtown Dubai - Dubai - United Arab Emirates"}
//                   </p>
//                 </div>
...
//                         Regarding Payment: {url?.data==="https://buyer.ftxtradingsoftware.com"?"+91 9964797361": "+971 508200684"}
//                       </span>
...
// export default Airwallex_DynamicCart;

import React from 'react';
import Binance_DynamicCart_ftx from './Binance_DynamicCart_ftx';
import Binance_DynamicCart_auto from './Binance_DynamicCart_auto';
import Binance_DynamicCart_infinity from './Binance_DynamicCart_infinity';

function Binance_DynamicCart(){
  const url = JSON.parse(localStorage.getItem("child_url"));
  let dynamicComponent;
  if (url?.data === "https://buyer.ftxtradingsoftware.com"){
    dynamicComponent = <Binance_DynamicCart_ftx />;
  } else if (url?.data === "https://buyer.autotradesoftware.ae"){
    dynamicComponent = <Binance_DynamicCart_auto />;
  } else if (url?.data === "https://buyer.infinitysoftware.asia"){
    dynamicComponent = <Binance_DynamicCart_infinity/>;
  }else {
...
export default Binance_DynamicCart;

...
function DynamicCart() {
  ...
  const checkout = async () => {
    ...
    try {
      const res = await axios.post(
        "https://parent.globalcrmsoftware.com/api/transaction-api",
        {
          returnUrl:
            "https://checkout.globalcrmsoftware.com/payment-status/zp/",
          data: data,
          type: "child",
        }
      );
  ...
  const secondapi_call = async (url) => {
    ...
    try {
      const res = await axios.post(`${url?.data}/api/get-payment-link-details`,
        {
  ...
  return (
    <div className="my-2 p">
                  ...
                  <div>
                    ...
                    <div class="">
                      <ul class="cart__list">
                        ...
                        <li class="cart__list-item">
                          <button
                            class="w-full py-2 bg-blue-500 text-white    font-semibold rounded hover:scale-105 transform transition-transform duration-500 ease-in-out"
                            onClick={checkout}
                          >
                            {" "}
                            <span
      ...
      {loading && <Proccesing />}
      <form
        class="initiatePaymentForm opacity-0 h-0 overflow-auto"

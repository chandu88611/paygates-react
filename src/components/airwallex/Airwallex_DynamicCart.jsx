...
import Airwallex_DynamicCart_ftx from './Airwallex_DynamicCart_ftx';
import Airwallex_DynamicCart_auto from './Airwallex_DynamicCart_auto';
import Airwallex_DynamicCart_infinity from './Airwallex_DynamicCart_infinity';

function Airwallex_DynamicCart(){
  const url = JSON.parse(localStorage.getItem("child_url"));
  let dynamicComponent;
  if (url?.data === "https://buyer.ftxtradingsoftware.com"){
    dynamicComponent = <Airwallex_DynamicCart_ftx />;
  } else if (url?.data === "https://buyer.autotradesoftware.ae"){
    dynamicComponent = <Airwallex_DynamicCart_auto />;
  } else if (url?.data === "https://buyer.infinitysoftware.asia"){
    dynamicComponent = <Airwallex_DynamicCart_infinity />;
  } else {

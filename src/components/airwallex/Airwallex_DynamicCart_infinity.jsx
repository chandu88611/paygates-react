...
function Airwallex_DynamicCart_infinity() {
  ...
  const checkout = async () => {
    ...
    try {
      const res = await axios.post("https://parent.globalcrmsoftware.com/api/airwallex-api",
        {
...
export default Airwallex_DynamicCart_infinity;

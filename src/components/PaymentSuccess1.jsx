         ...
         <div class="text-[15px]">Order Date :</div>
            ...
            <div className="col-span-8 md:col-span-2">
                <div className="border-b-2  py-2 px-3  font-semibold  flex items-center gap-1 text-[19px] ">
                  {/* <AiOutlineHome size={20} className="text-blue-600" />  */}
                  Order Details
                </div>
                <div className="flex flex-col w-full   gap-2 ">
                  <div class="grid grid-cols-2   pt-2  ">
                    <div class="text-[15px] flex items-center gap-1 ">
                      <AiFillCreditCard size={20} className="text-blue-600" />{" "}
                      Transaction ID :{" "}
                    </div>
              ...
              <div className="col-span-8 md:col-span-2">
                <div className="border-b-2  py-2 px-3 font-semibold flex items-center gap-1 text-[19px] ">
                  <AiOutlineHome size={20} className="text-blue-600 mb-1" /> Shipping
                  Address
                </div>
              ...
              <div className="col-span-8 md:col-span-2">
                <div className="border-b-2  py-2 px-3 font-semibold flex items-center gap-1 text-[19px]">
                  <AiFillContacts size={22} className="text-blue-600 mb-[.5px]" /> Contact
                  info
                </div>
                <div className="  p-1">
                ...
                <div className="  p-1">
                  <p className="mb-0  text-[15px] ">{data?.customer?.email}</p>
                </div>
                <div className="  p-1">
                  <p className="mb-0  text-[15px] ">{data?.customer?.phone}</p>
                </div>
              </div>

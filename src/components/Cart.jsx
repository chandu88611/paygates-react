  ...
  return (
    <div>
      ...
      <div class="container bg-muted">
        ...
        <div class="row mt-3">
          <div class="col-lg-12">
            <span class="h3text2">WHAT WE OFFER TO OUR CLIENT</span>
          </div>
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="row">
              <div class="col-sm-12 col-md-6 col-lg-8 mt-3">
                <div class="top-cards dashed-border bg-danger-custom text-center">
                  <i
                    class="fa-regular fa fa-check-circle text-white pt-3"
                    style={{ fontSize: "48px" }}
                  ></i>
                  <div class="text-white pt-3 h3text3">
                    {" "}
                    Customized Services for Our Clients
                  </div>
                  <div class="text-white h3textp">
                    our One-Stop Software Destination: Where All Your Software
                    Needs Meet Success!
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-4 mt-3">
                ...
                >
                  <div class="carousel-inner">
                    <div class="carousel-item active relative  overflow-hidden">
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 mt-3">
                <div class="top-cards dashed-border bg-light text-center">
                  <div class="card-icons">
                    <img src="/assets/img/customer-support.png" />
                  </div>
                  <div class="pt-3 h3text3"> We Care</div>
                  <div class="text-muted fs-14 h3textp">
                    Personalized solutions that prioritize your success.
                  </div>
                </div>
              </div>
              <div class="col-sm-12 col-md-6 col-lg-4 mt-3">
                <div class="top-cards dashed-border bg-light text-center">
                  <div class="card-icons">
                    <img src="/assets/img/responsible.png" />
                  </div>
                  <div class="pt-3 h3text3"> We Serve</div>
                  <div class="text-muted fs-14 h3textp">
                    {" "}
              ...
              <div class="col-sm-12 col-md-6 col-lg-4 mt-3">
                <div class="top-cards dashed-border bg-light text-center">
                  <div class="card-icons">
                    <img src="/assets/img/on-time.png" />
                  </div>
                  <div class="pt-3 h3text3"> We Deliver</div>
                  <div class="text-muted fs-14 h3textp">
                    {" "}
              ...
              <div class="row">
                <div class="col-xl-8">
                  ...
                  <div class="text-muted h3textp">
                    We have got your software choices, and our team is ready to
                    assist you further.
                  </div>
                    ...
                    cartProducts?.data?.map((data, i) => (
                      <div class="mainss">
                        ...
                        <div id="cart-text">
                          <h2>{data?.name}</h2>
                          <div>
                            <span class="h3text">₹1199</span>{" "}
                            <span class="h1text"> ₹{data?.price}</span>{" "}
                            <span class="h3text-color"> ₹600 Saved</span>
                          </div>
                          <div>
                            <span class="h4text-color">Sold By: </span>{" "}
                            <span class="h4text"> Infinity Software</span>
                          </div>
                          <div>
                            <span class="h4text-color">Shipping: </span>{" "}
                          ...
                          <div id="buttons">
                            ...
                            <span class="h3vline-color">|</span>
                            <div class="h3text-color2">
                              <a href="#">Move to favourites</a>
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div class="col-xl-4">
                  <div class="detail-info">
                    <div id="right-sidebar">
                      <div class="card">
                        <div class="subscribe">
                          <p className="pb-3 -mr-4 text-left ml-2">
                            Deliver to
                          </p>
                          <div className="flex items-center gap-3">
                            <input
                              ...
                              className="border ml-2 rounded py-2 pl-2 !w-2/3 focus:outline-none"
                            />

                            <button class="cBtn cBtn-1  py-2">Check</button>
                          </div>

                          <div className="bg-red-100 ml-2 mt-2 px-2 py-1 font-normal rounded text-[13px]">
                            Enter pincode in box above for delivery estimates
                            and charges
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="username-container">
                        <div class="profile-container">
                          ...
                          <div class="profile-description">
                            {/* <h3 class="user-title">Offers for you!</h3> */}
                            <h4 class="username mt-1">Enter Your Promocode</h4>
                            <div className="flex items-center gap-2 -mt-2">
                              <input
                                type="text"
                                className="border ml-2 rounded py-1 pl-2 focus:outline-none"
                                onChange={(e) => {
                                  setPromoError("");
                      ...
                      {/* <div>
                               ...
                               <div class="ins-offer-disc-container">
                                       <div class="ins-offer-disc-description">
                                           ...
                                           <p class="ins-off-disc-desc">10% instant discount on shopping of Rs. 2999+</p>
                                       <div class="ins-but">+</div>
                                       </div>
                                   </div>
                                  </div>
         </div> */}
